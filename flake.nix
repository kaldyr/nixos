{
    ...
    inputs = {
        ...
        nixpkgs-zellij.url = "github:NixOS/nixpkgs/dd90985ce9082d8b39ec31af52b2e6070d0f12b2";
        nixpkgs-cava.url = "github:NixOS/nixpkgs/1dfebceb6e98e46cd24052f71207d66bc2e3ed82";
