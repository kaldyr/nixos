{ pkgs, sysConfig, ... }: {
    ...
    home-manager.users.${sysConfig.user} = {
        ...
        xdg = {
            ...
            mimeApps.associations.added."application/audio" = [ "mpv.desktop" ];
            mimeApps.associations.added."application/video" = [ "mpv.desktop" ];
